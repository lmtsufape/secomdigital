						...
						<form action="<?php echo e(route('image.update')); ?>" method="POST" enctype="multipart/form-data">	
							  ...
							  <div class="form-row">
							    <div class="col-3">
							      ...
							      <input type="text" class="form-control" name="eixo_x" value="<?php echo e($eixo_x ?? 1100); ?>" id="formGroupExampleInput" >
							    </div>
							    <div class="col-3">
							      <label for="formGroupExampleInput">Eixo y:</label>
							      <input type="number" class="form-control" name="eixo_y"  value="<?php echo e($eixo_y ?? 100); ?>" id="formGroupExampleInput" >
							    </div>
							    <div class="col-3">
							      <label for="formGroupExampleInput">Tamanho:</label>
							      <input type="number" class="form-control" name="size"  value="<?php echo e($size ?? 50); ?>" id="formGroupExampleInput" >
							    </div>
							  </div>					  
							  <div class="form-group" >
